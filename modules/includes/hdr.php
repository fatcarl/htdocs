<h3 data-brackets-id='181' class="text-muted"> <img src="/images/bcitlogo.jpeg" width="188" height="88"> BCIT CSCE Student Chapter <img src="/images/cscelogo.jpeg" width="88" height="88"></h3>
        <ul data-brackets-id='182' class="nav nav-justified">
          ...
          <li id="events"data-brackets-id='187' <? if($sec=="events") echo "class=\"active\""; ?>><a data-brackets-id='188' href="../events">Events</a></li>
          <li id="about"data-brackets-id='191' <? if($sec=="about") echo "class=\"active\""; ?>><a data-brackets-id='192' href="../about">About</a></li>
          <li id="contact"data-brackets-id='193' <? if($sec=="contact") echo "class=\"active\""; ?>><a data-brackets-id='194' href="../contact">Contact</a></li>
        </ul>
