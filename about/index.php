...
<!DOCTYPE html>
  ...
  <body > 
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>Testies!</h1>
        <p class="lead">The BCIT Student Chapter of the CSCE is the largest student chapter in Canada and boasts a consecutive 100% membership rate amongst third and fourth year Civil Engineering students since it's inception. </p>
            
         <p> Every year the largest student association at BCIT makes an impact. Whether it's hosting technical seminars, funding student competitions, raising money for charity, organizing field trips, or sending representatives to engineering-related conferences, the CSCE is involved. </p>
          
          <p> On top of all that, the CSCE hosts social events throughout the year, and organizes our annual professional night where students are able to meet the faces behind the local engineering community.</p>
